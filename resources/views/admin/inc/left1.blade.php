	...
	<div class="container">
		...
		<div class="leftsidebar_box">
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
																			src="/admin/img/coin222.png" /><a href="{{route('lianjielist')}}"
																											  target="main" class="cks">列表管理</a><img class="icon5"
																																					 src="/admin/img/coin21.png" />
				</dd>
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" />
					<img class="coin22" src="/admin/img/coin222.png" />
					<a href="{{route('lianjieadd')}}" target="main" class="cks">添加管理</a>
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
						src="/admin/img/coin222.png" /><a class="cks" href="{{route('banner')}}"
						target="main">列表管理</a><img class="icon5" src="/admin/img/coin21.png" />
				</dd>
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
						src="/admin/img/coin222.png" /><a class="cks" href="{{route('banneradd')}}"
						target="main">添加管理</a><img class="icon5" src="/admin/img/coin21.png" />
				</dd>
			</dl>
			<dl class="system_log">
				<dt>
				...
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
						src="/admin/img/coin222.png" /><a href="{{route('topicadd')}}" target="main"
						class="cks">分类添加</a><img class="icon5" src="/admin/img/coin21.png" />
				</dd>
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" />
					<img class="coin22" src="/admin/img/coin222.png" />
					<a href="{{route('topicaddlist')}}" target="main" class="cks">分类展示</a>
					<img class="icon5" src="/admin/img/coin21.png" />
				</dd>
			</dl>
			<dl class="system_log">
				<dt>
					<img class="icon1" src="/admin/img/coin10.png" /><img class="icon2"
						src="/admin/img/coin09.png" /> 管理员<img class="icon3"
						src="/admin/img/coin19.png" /><img class="icon4"
						src="/admin/img/coin20.png" />
				</dt>
				<dd>
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
																			src="/admin/img/coin222.png" /><a href="" target="main"
																											  class="cks">文章添加</a><img class="icon5" src="/admin/img/coin21.png" />
				</dd>
			</dl>
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" /><img class="coin22"
						src="/admin/img/coin222.png" /><a href="{{route('goods')}}" target="main"
						class="cks">商品添加</a><img class="icon5" src="/admin/img/coin21.png" />
				</dd>
				<dd>
					<img class="coin11" src="/admin/img/coin111.png" />
					<img class="coin22" src="/admin/img/coin222.png" />
					<a href="{{route('goods_list')}}" target="main" class="cks">商品列表</a>
					<img class="icon5" src="/admin/img/coin21.png" />
				</dd>
			</dl>
			<dl class="system_log">
