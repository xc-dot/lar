  ...
  <body>
    <div class="maincont">
     ...
     <div id="sliderA" class="slider">
         <img src="{{env('UOLOAD_URL')}}/{{$data->goods_img}}" />
         <img src="{{env('UOLOAD_URL')}}/{{$data->goods_img}}" />
     </div><!--sliderA/-->
     <table class="jia-len">
      <tr>
       ...
       <td>
        <input type="text" name="goods_number" class="spinnerExample" />
       </td>
      </tr>
      <tr>
       <td>
     ...
     <table class="jrgwc">
      <tr>
       ...
       <td><a href="{{url('/index/car_do/'.$data->goods_id)}}">加入购物车</a></td>
      </tr>
     </table>
    </div><!--maincont-->
   ...
   <script>
	$('.spinnerExample').spinner({});
        $('[name="goods_number"]').chenge(function(){
    })
	</script>
  </body>
</html>